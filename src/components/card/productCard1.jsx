    ...
    return (
        <div className='group overflow-hidden'>
            <div className="image w-[267px] h-[264px] relative">
                <div className="w-[267px] h-[264px] group-hover:opacity-100 opacity-0 absolute left-0 top-0 bg-[#282828CC]  transition-all duration-500 z-50">
                </div>
            ...
            <div className='flex justify-center items-center flex-col'>
                <Link href={`/products/${item?.slug}`} >
                    <h2 className="text-[20px] font-semibold leading-[24px] tracking-[0%] text-center text-[#282828] mt-5 hover:text-[#F47606] transition-all duration-500">{item?.name}</h2></Link>

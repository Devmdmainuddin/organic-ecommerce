    ...
    return (
        <div className='w-full h-auto lg:h-[666px] bg-gray-100 my-[130px] relative'>
            ...
            <Swiper
                ...
                <SwiperSlide>
                    <div className='py-[130px] flex gap-6 md:gap-16 lg:gap-[95px] justify-between flex-wrap items-center relative'>
                        <div className="content w-[483px] h-[335px] ">
                            <h2 className="text-gray-800 font-bold text-3xl leading-[42px]">Testimonial</h2>
